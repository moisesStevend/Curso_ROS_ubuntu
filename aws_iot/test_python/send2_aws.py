...
awshost = "a3esjcuqr58jgm.iot.us-west-2.amazonaws.com"
awsport = 8883
clientId = "temp_dht11"
thingName = "temp_dht11"
caPath = "root-CA.crt"
certPath = "temp_dht11.cert.pem"
keyPath = "temp_dht11.private.key"
...
while 1==1:
    ...
    if connflag == True:
        ...
        mqttc.publish("temp_dht11-Policy", tempreading, qos=1)
